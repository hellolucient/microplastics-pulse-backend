...
async function generateAndStoreImage(title, articleUrl) {
    ...
    const new_prompt = `Create a professional editorial photograph for an article about "${title.substring(0, 150)}". 
...
- Focus on symbolic objects or environmental scenes related to the topic
...
The image should communicate the article's theme through visual symbolism only, without any textual elements whatsoever.`;
