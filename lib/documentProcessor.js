...
class DocumentProcessor {
  ...
  async extractPDFContent(fileBuffer) {
    try {
      ...
      // Clean each page text to match the main content cleaning
      const cleanedPages = pdfData.pages.map(page => this.cleanText(page));
      ...
      return {
        text: fullText,
        pages: cleanedPages, // Array of cleaned page texts
        metadata: {
